export const products = [
  ...
  },
  {
    ...
    description:
      'Fair & Clear is Pakistans only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no side effects.',
    price: 70,
  ...
  },
  {
    ...
    description:
      'Stylish Watch For Man (Luxury) Classy Mens Stainless Steel Wrist Watch - Box Packed',
    price: 47,
